    ...
    >
      <Box sx={{ position: 'absolute', right: 18, bottom: 80, zIndex: 8 }}>
        <Image
          ...
          disabledEffect
          alt="myphoto"
          src="/assets/images/course/profile.png"
      ...
      <Box
        {...varUp}
        component={m.div}
        sx={{ zIndex: 9, left: 120, bottom: 100, position: 'absolute' }}
      >
        <Label
          text="React"
          icon={
      ...
      <Box
        {...varLeft}
        component={m.div}
        sx={{ top: 88, right: 52, zIndex: 8, position: 'absolute' }}
      >
        <Icon
          color={ORANGE}
          content={
      ...
      <Box {...varRight} component={m.div} sx={{ zIndex: 8, bottom: 160,right:20, position: 'absolute' }}>
        <Icon 
          color={YELLOW}
          content={
            <Image
