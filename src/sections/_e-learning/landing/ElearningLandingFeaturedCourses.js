...
import img4 from '../../../_mock/assets/course/chicagobakes.png';
...
const myProjects = [
  ...
  {
    title: 'Chicago Bakes',
    url: 'https://chicagobakes.com/',
    img:img4,
    alt: 'chicago bakes',
    description: `This Chicago Bakes project is a standout addition to my portfolio, showcasing my frontend skills. It revolves around an elegant bakery I developed using React. Rest assured, it boasts a user-friendly interface and visually appealing aesthetics. With a contemporary design, I strived to create an immersive custom cakes sale experience for customers.`,
  },
  {
    title: 'Spy Game',
